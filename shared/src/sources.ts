...
export const SOURCE_CATALOG: SourceDefinition[] = [
  {
    ...
    taskBuilderFields: [
      ...
      },
      {
        ...
        required: true,
        placeholder: '例如：民法',
        description: '第一版會在官方法規資料集中比對法規名稱。',
      },
      {
        name: 'exactMatch',
        label: '精準比對名稱',
  ...
  },
  {
    ...
    taskBuilderFields: [
      ...
      },
      {
        ...
        type: 'url',
        required: true,
        placeholder: 'https://www.judicial.gov.tw/tw/lp-1724-1.html',
      },
      {
        name: 'maxPages',
        label: '最多抓取頁數',
  ...
  },
  {
    ...
    taskBuilderFields: [
      ...
      },
      {
        ...
        required: true,
        placeholder: '1038',
        description: '可由司法院開放資料平台查得。第一版優先支援 JSON/CSV 檔型 fileset。',
      },
      {
        name: 'top',
        label: '取得筆數上限',
